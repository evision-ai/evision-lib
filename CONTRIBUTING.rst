...
When `reporting a bug <https://github.com/dectinc/evision-lib/issues>`_ please include:
...
The best way to send feedback is to file an issue at https://github.com/dectinc/evision-lib/issues.
...
1. Fork `evision-lib <https://github.com/dectinc/evision-lib>`_
   (look for the "Fork" button).
2. Clone your fork locally::

    git clone git@github.com:dectinc/evision-lib.git
